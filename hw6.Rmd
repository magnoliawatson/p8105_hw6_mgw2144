...
I chose to use a stepwise compariosn of the model for the building process to determine the final linear regression model. The final model contains eleven predictors with the outcome variable birthweight. 
